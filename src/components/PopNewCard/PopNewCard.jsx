        ...
        <PopNewCardBlock>
          <PopNewCardContent>
            ...
            <PopNewCardCategories>
              ...
              <CategoriesThemes>
                <CategoriesTheme $bgColor={themeColors['Web Design'].bg} $textColor={themeColors['Web Design'].text} $isActive={selectedTopic === 'Web Design'} onClick={() => setSelectedTopic('Web Design')}>
                  <CategoriesThemeP>Web Design</CategoriesThemeP>
                </CategoriesTheme>
                <CategoriesTheme $bgColor={themeColors['Research'].bg} $textColor={themeColors['Research'].text} $isActive={selectedTopic === 'Research'} onClick={() => setSelectedTopic('Research')}>
                  <CategoriesThemeP>Research</CategoriesThemeP>
                </CategoriesTheme>
                <CategoriesTheme $bgColor={themeColors['Copywriting'].bg} $textColor={themeColors['Copywriting'].text} $isActive={selectedTopic === 'Copywriting'} onClick={() => setSelectedTopic('Copywriting')}>
